<footer id="footer">
  ...
  <div id="footer-links-container">
    <ul>
      <li><a class="link" href="#">Adicionar filme</a></li>
      <li><a class="link" href="#">Adicionar crítica</a></li>
      <li><a class="link" href="#">Entrar e Registrar </a></li>
    </ul>
  </div>
  <p>&copy; Leonardo Sarquiz Hugenthobler</p>
</footer>
